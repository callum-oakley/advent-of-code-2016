...
import * as day19 from "./day-19.js";
import input19 from "./input-19.json";
import * as day20 from "./day-20.js";
import input20 from "./input-20.json";
import * as day21 from "./day-21.js";
import input21 from "./input-21.json";
...
time = Date.now();
console.log("--- part 1 ---");
console.log(`solution: ${day21.part1(input21)}, time: ${Date.now() - time}ms\n`);
console.log("--- part 2 ---");
time = Date.now();
console.log(`solution: ${day21.part2(input21)}, time: ${Date.now() - time}ms\n`);
// console.log("--- DAY 22 ---");
// time = Date.now();
// console.log("--- part 1 ---");
